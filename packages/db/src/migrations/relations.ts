...
import { user, orders, orderItems, products, account, session, address, categories, subcategories, vendors, productEventTypes, eventTypes, productImages, productPrices, productShippingOptions, productSpecifications, productVariants, reviews, reviewImages, reviewVotes, vendorRatings } from "./schema";
...
export const productEventTypesRelations = relations(productEventTypes, ({one}) => ({
	product: one(products, {
...
export const productShippingOptionsRelations = relations(productShippingOptions, ({one}) => ({
	product: one(products, {
