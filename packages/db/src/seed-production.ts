...
async function downloadAndUploadImage(
  ...
  try {
    ...
    if (!response.ok) {
      console.log(
        `    ⚠️ Image not available (${response.status}), using placeholder`,
      )
...
async function uploadSeedImages(): Promise<Map<string, string>> {
  ...
  const images = [
    ...
    {
      source:
        'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=1920&h=600&fit=crop',
      banner: 'hero-decorations',
    },
    {
      source:
        'https://images.unsplash.com/photo-1513151233558-d860c5398176?w=1920&h=600&fit=crop',
      banner: 'hero-party',
    },
    {
      source:
        'https://images.unsplash.com/photo-1519167758481-83f29da8c6c9?w=1920&h=600&fit=crop',
      banner: 'hero-furniture',
    },
    ...
    {
      source:
        'https://images.unsplash.com/photo-1598387993441-a364f854c3e1?w=400&h=300&fit=crop',
      promo: 'promo-sound',
    },
    {
      source:
        'https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=400&h=300&fit=crop',
      promo: 'promo-entertainment',
    },
    ...
    },
    {
      ...
      product: 'birthday-decor',
    },
    {
      source: 'https://images.unsplash.com/photo-1557683316-973673baf926?w=800',
      product: 'neon-sign',
    },
    {
      source:
    ...
    {
      source: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800',
      product: 'chiavari-chair',
    },
    {
      source:
    ...
    },
    {
      ...
      product: 'wedding-tent',
    },
    {
      source:
        'https://images.unsplash.com/photo-1478146896981-b80fe463b330?w=800',
      product: 'party-canopy',
    },
    {
      source: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800',
      product: 'lounge-furniture',
    },
    {
      source: 'https://images.unsplash.com/photo-1555244162-803834f70033?w=800',
      product: 'chafing-dish',
    },
    {
      source:
        'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800',
      product: 'bar-equipment',
    },
    {
      source: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800',
      product: 'serving-trays',
    },
    {
      source:
    ...
    },
    {
      ...
      product: 'groom-sherwani',
    },
    {
      source:
        'https://images.unsplash.com/photo-1583912086096-8c60d75a53f9?w=800',
    ...
    {
      source: 'https://images.unsplash.com/photo-1544145945-f90425340cf7?w=800',
      product: 'beverage-dispenser',
    },
    {
      source:
        'https://images.unsplash.com/photo-1519167758481-83f29da8c6c9?w=800',
      product: 'furniture-general',
    },
  ]
...
const CATEGORIES_DATA = [
  ...
  },
  {
    ...
    icon: 'Mic',
    description:
      'Professional audio and lighting equipment for events of all sizes.',
    subcategories: [
...
const VENDORS_DATA: Array<{
...
}> = [
  {
    ...
    description:
      "Dhaka's premier event rental service since 2015. Quality products, timely delivery, and professional setup.",
    location: 'Dhaka',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      'Specializing in luxury wedding decor and furniture. From traditional Bengali weddings to modern ceremonies.',
    location: 'Dhaka',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      'Professional sound systems and lighting solutions for events of all sizes.',
    location: 'Dhaka',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      "Chittagong's favorite party supply store. Balloons, decorations, and everything for memorable celebrations.",
    location: 'Chittagong',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      'Bringing elegance to every occasion in Sylhet. Wedding decor, furniture rental, and event styling.',
    location: 'Sylhet',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      'Premium photo booth rentals with instant printing and social media sharing.',
    location: 'Dhaka',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      'Premium tent and canopy rentals for outdoor events. Professional setup included.',
    location: 'Dhaka',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      'Beautiful fresh and artificial flower arrangements for weddings and special occasions.',
    location: 'Dhaka',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      'Everything for kids parties! Bounce houses, carnival games, cartoon characters, and themed decorations.',
    location: 'Dhaka',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      'Complete corporate event solutions. Conference setups, stage decoration, and audio-visual equipment.',
    location: 'Dhaka',
    isVerified: true,
  ...
  },
  {
    ...
    description:
      'Authentic Bengali wedding and event decoration. Shola decor, alpana, and cultural setups.',
    location: 'Dhaka',
    isVerified: true,
...
function createProducts(imageUrls: Map<string, string>): Array<any> {
  const getImage = (originalUrl: string) =>
    imageUrls.get(originalUrl) || originalUrl
  ...
  return [
    {
      ...
      description:
        'Create stunning balloon arches with our premium kit. Includes 150+ high-quality latex balloons in rose gold, pink, and white, decorative strip, and electric pump. Perfect for wedding entrances, birthday parties, and photo backdrops.',
      ...
      images: [
        {
          ...
          alt: 'Rose gold balloon arch kit',
          isPrimary: true,
        },
      ],
      variants: [
      ...
      content: {
        keyFeatures: [
          '150+ premium latex balloons',
          'Electric balloon pump included',
          '5m decorating strip',
          'Easy assembly guide',
        ],
        whatsIncluded: [
          '60 rose gold balloons',
          '40 pink balloons',
          '50 white balloons',
          '5m decorating strip',
          'Electric pump',
        ],
        badges: ['choice', 'top_seller'] as Array<string>,
    ...
    },
    {
      ...
      description:
        '40-inch metallic gold number balloons for birthdays and anniversaries. Self-sealing, helium-quality balloons.',
    ...
    },
    {
      ...
      description:
        'Beautiful LED curtain lights for backdrop decoration. 300 warm white LEDs, 8 lighting modes, remote control included.',
    ...
    },
    {
      ...
      description:
        'Personalized LED neon sign for your special event. Custom text up to 12 characters.',
    ...
    },
    {
      ...
      description:
        'Stunning artificial flower wall backdrop featuring premium silk roses. 2.4m x 2.4m panel.',
    ...
    },
    {
      ...
      description:
        'Complete wedding stage decoration set includes fabric draping, LED lights, flower arrangements, and decorative elements.',
    ...
    },
    {
      ...
      description:
        'Professional 240W portable PA system with built-in light show. Bluetooth connectivity, microphone input. 18-hour battery life.',
    ...
    },
    {
      ...
      description:
        'Complete professional PA system with 2x 15" speakers, 10-channel mixer, wireless microphones. Includes delivery and setup in Dhaka.',
    ...
    },
    {
      ...
      description:
        'Professional wireless microphone system with 2x SM58 legendary vocal mics. Crystal clear sound, 100m range.',
    ...
    },
    {
      ...
      description:
        'Professional 2-channel DJ controller compatible with Rekordbox and Serato DJ.',
      ...
      content: {
        keyFeatures: [
          'Compatible with Rekordbox/Serato',
          'Large jog wheels',
          'Performance pads',
          'Built-in sound card',
        ],
    ...
    },
    {
      ...
      description:
        'Complete stage lighting package with 8x LED PAR cans and 4x moving head lights. DMX controller included.',
    ...
    },
    {
      ...
      description:
        'Full HD 1080p projector with 3000 lumens brightness. Includes 100-inch motorized screen.',
    ...
    },
    {
      ...
      description:
        'Elegant gold chiavari chairs perfect for weddings and formal events. Premium polycarbonate construction with comfortable cushion. Minimum rental: 50 chairs.',
    ...
    },
    {
      ...
      description:
        'Professional 5ft round banquet table seats 8-10 guests. Folding legs for easy storage.',
    ...
    },
    {
      ...
      description:
        'Large 40x60ft wedding tent accommodates up to 300 guests. White canvas with aluminum frame. Includes sidewalls, lighting, and professional setup.',
    ...
    },
    {
      ...
      description:
        'Complete modern lounge set includes 2x sofas, 2x armchairs, 1x coffee table, and 2x side tables.',
    ...
    },
    {
      ...
      description:
        'Premium spandex chair covers with matching sashes. Fits standard chiavari and folding chairs.',
    ...
    },
    {
      ...
      description:
        'Professional full-size chafing dish with fuel holders. Keeps food warm for hours.',
    ...
    },
    {
      ...
      description:
        'Elegant 3-gallon beverage dispenser with metal stand and spigot. BPA-free acrylic container.',
      ...
      images: [
        {
          url: getImage(
            'https://images.unsplash.com/photo-1544145945-f90425340cf7?w=800',
          ),
    ...
    },
    {
      ...
      description:
        'Complete bar setup includes cocktail shaker, jigger, muddler, strainer, bar spoon, cutting board, and ice bucket.',
    ...
    },
    {
      ...
      description:
        'Professional 360-degree video booth creates stunning slow-motion videos. Operator included.',
    ...
    },
    {
      ...
      description:
        'Traditional photo booth with instant prints. Includes props, backdrop, and attendant.',
    ...
    },
    {
      ...
      description:
        'Professional 18-inch LED ring light with adjustable stand. Phone holder included.',
    ...
    },
    {
      ...
      description:
        'Professional aerial photography and videography with DJI Mavic 3. Licensed pilot included.',
    ...
    },
    {
      ...
      description:
        'Complete disposable dinnerware for 100 guests. Premium plastic plates, cups, and cutlery.',
    ...
    },
    {
      ...
      description:
        'Party confetti cannons for spectacular celebrations. 10 pack with biodegradable paper confetti.',
    ...
    },
    {
      ...
      description:
        'Elegant 3-tier acrylic cake stand for weddings and parties. Crystal clear design.',
    ...
    },
    {
      ...
      description:
        'Premium groom sherwani with intricate embroidery. Complete set includes sherwani, churidar, stole, and mojari shoes.',
    ...
    },
    {
      ...
      description:
        'Stunning designer bridal lehenga with heavy embroidery and dupatta. Premium quality fabric.',
    ...
    },
    {
      ...
      description:
        'Premium black tuxedo suit for formal events. Includes jacket, pants, shirt, bow tie, and cummerbund.',
    ...
    },
    {
      ...
      description:
        'Adorable formal suit set for boys. Includes jacket, shirt, pants, and bow tie. Ages 2-12.',
    ...
    },
    {
      ...
      description:
        'Elegant white floral backdrop panel for wedding ceremonies. 8x8ft with artificial flowers and greenery.',
    ...
    },
    {
      ...
      description:
        'Professional pipe and drape system for creating elegant backdrops. 20ft wide x 10ft tall.',
    ...
    },
    {
      ...
      description:
        'Luxurious red velvet stage curtain. 20x12ft with gold fringe.',
    ...
    },
    {
      ...
      description:
        "Stunning fresh flower bridal bouquet with roses, lilies, and baby's breath. Custom color options available.",
    ...
    },
    {
      ...
      description:
        'Elegant floral table centerpiece with fresh or artificial flowers.',
    ...
    },
    {
      ...
      description:
        'Large castle-themed bounce house for kids parties. Accommodates 8-10 children.',
    ...
    },
    {
      ...
      description:
        'Complete carnival game package with 5 classic games: Ring Toss, Can Knockdown, Duck Pond, Balloon Darts, and Spin-to-Win.',
    ...
    },
    {
      ...
      description:
        'Complete karaoke system with 2 wireless microphones, speaker, and screen. 10,000+ Bengali and Hindi songs.',
    ...
    },
    {
      ...
      description:
        'Giant Jenga game with premium wooden blocks. Stacks over 5ft tall!',
    ...
    },
    {
      ...
      description:
        'Professional magician for your event! 45-minute show with interactive tricks and illusions.',
...
async function seedProducts(
  ...
  for (let i = 0; i < products.length; i++) {
    ...
    if (existing.length > 0) {
      ...
      await db
        .delete(schema.productEventTypes)
        .where(eq(schema.productEventTypes.productId, productId))
    } else {
      productId = nanoid()
...
async function seedSampleUsers() {
  ...
  for (let i = 0; i < usersNeeded; i++) {
    ...
    await db.insert(schema.user).values({
      id: userId,
      name:
        VENDORS_DATA[userIds.length - 1]?.name || `Vendor ${userIds.length}`,
      email,
      emailVerified: true,
      role: 'vendor',
  ...
  const banners = [
    {
      ...
      subtitle:
        'Transform your special day with our premium wedding decor and furniture rentals',
    ...
    },
    {
      ...
      subtitle:
        'Balloon arches, flower walls, LED lights - everything for a memorable event',
    ...
    },
    {
      ...
      subtitle:
        'Make every celebration unforgettable with our complete party solutions',
    ...
    },
    {
      ...
      subtitle:
        'Elegant chiavari chairs, banquet tables, and lounge sets for your guests',
...
async function main() {
  ...
  try {
    ...
    console.log('\n📊 Summary:')
    console.log(
      `  ✓ ${(await db.select().from(schema.categories)).length} Categories`,
    )
    console.log(
      `  ✓ ${(await db.select().from(schema.subcategories)).length} Subcategories`,
    )
    console.log(
      `  ✓ ${(await db.select().from(schema.eventTypes)).length} Event Types`,
    )
    console.log(
      `  ✓ ${(await db.select().from(schema.vendors)).length} Vendors`,
    )
    console.log(
      `  ✓ ${(await db.select().from(schema.products)).length} Products`,
    )
    console.log(
      `  ✓ ${(await db.select().from(schema.productImages)).length} Product Images`,
    )
    console.log(
      `  ✓ ${(await db.select().from(schema.reviews)).length} Reviews`,
    )
    console.log(
      `  ✓ ${(await db.select().from(schema.homeBanners)).length} Home Banners`,
    )
    console.log(
      `  ✓ ${(await db.select().from(schema.homePromoCards)).length} Promo Cards`,
    )
    console.log(
      `  ✓ ${(await db.select().from(schema.coupons)).length} Coupons`,
    )
