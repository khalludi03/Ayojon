import { z } from "zod";
import { publicProcedure, protectedProcedure, adminProcedure, os } from "../index";
...
export const couponRouter = os.router({
  validateCoupon: publicProcedure
    .route({
      ...
      description: "Validates a coupon code and returns the discount details if valid.",
      tags: ["Coupon"],
    })
    .input(
      z.object({
  ...
  incrementUsage: protectedProcedure
    .route({
      ...
      description: "Increments the usage count of a coupon after successful order.",
      tags: ["Coupon"],
    })
    .input(
      z.object({
