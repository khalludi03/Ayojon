    ...
    <div className="rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] overflow-hidden shadow-sm">
      <div className="p-4 sm:p-6 border-b border-[hsl(var(--border))] flex items-center justify-between bg-[hsl(var(--muted))]/30">
        ...
        <Button
          variant="ghost"
          size="sm"
          className="font-bold text-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/10 text-xs sm:text-sm"
          asChild
        >
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-[hsl(var(--muted))]/10">
              <th className="px-6 py-4 text-left text-[10px] font-black text-[hsl(var(--muted-foreground))] uppercase tracking-[0.1em]">
                Order Details
              </th>
              <th className="px-6 py-4 text-left text-[10px] font-black text-[hsl(var(--muted-foreground))] uppercase tracking-[0.1em]">
                Customer
              ...
              <th className="px-6 py-4 text-right text-[10px] font-black text-[hsl(var(--muted-foreground))] uppercase tracking-[0.1em]">
                Action
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[hsl(var(--border))]">
            {orders.length > 0 ? (
              orders.map((order: any) => (
                <tr
                  key={order.id}
                  className="group hover:bg-[hsl(var(--muted))]/30 transition-colors"
                >
