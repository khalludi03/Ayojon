...
import type { Product, SortOption, Vendor } from '@/types'
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
interface VendorStorePageProps {
  vendor: Vendor
  initialCategoryIds?: Array<string>
                  ...
                  <div
                    className={cn(
                      ...
                      isSelected
                        ...
                        : 'border-[hsl(var(--border))] bg-background group-hover:border-primary/50',
                    )}
                  >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage className="text-xs font-semibold text-[hsl(var(--foreground))] sm:text-sm">
                  {vendor.name}
                </BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          ...
          <div className="relative z-10 flex flex-col items-center sm:flex-row sm:items-end sm:gap-8">
            ...
            <div className="hidden items-end gap-4 pb-2 lg:flex">
              ...
              <div className="flex items-center gap-4 rounded-2xl border-2 border-[hsl(var(--border))] bg-[hsl(var(--card))] px-5 py-3 shadow-sm transition-colors hover:border-primary/30">
                ...
                <div>
                  <p className="text-lg font-black leading-tight text-success">
          ...
          {vendor.description && (
            <div className="mt-8 border-t border-[hsl(var(--border))] pt-8">
              <div className="max-w-4xl">
                <h2 className="mb-3 text-sm font-bold uppercase tracking-widest text-[hsl(var(--muted-foreground))]">
                  About this Store
                </h2>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                >
                  <SheetTrigger asChild>
                    <Button
                      variant="outline"
                      className="h-10 gap-2 rounded-xl border-2 font-bold lg:hidden"
                    >
                  ...
                  <SheetContent
                    side="bottom"
                    className="h-[80vh] rounded-t-3xl p-6"
                  >
            ...
            {isProductsLoading ? (
              ...
              <div className="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-[hsl(var(--border))] py-24 text-center">
                ...
                <p className="max-w-xs text-[hsl(var(--muted-foreground))]">
                  We couldn't find any products in this category. Try clearing
                  your filters.
                </p>
                <Button
                  onClick={clearAllFilters}
