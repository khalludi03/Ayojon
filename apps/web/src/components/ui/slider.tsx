  ...
  >
    ...
    {props.defaultValue?.map((_, index) => (
      <SliderPrimitive.Thumb
        key={index}
        className="block h-5 w-5 rounded-full border-2 border-[hsl(var(--primary))] bg-[hsl(var(--background))] ring-offset-[hsl(var(--background))] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
      />
    )) || (
...
function RangeSlider({
  ...
  return (
    <div className={cn('w-full', className)}>
      ...
      <div className="mt-2 flex justify-between text-sm text-[hsl(var(--muted-foreground))]">
