...
export function ProductDetailPage({
  ...
  const handleTwitterShare = () => {
    window.open(
      `https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(product.title)}`,
      '_blank',
    )
  }
  ...
  const status =
    (stockStatusInfo as any)[product.stockStatus] ?? stockStatusInfo.in_stock
          ...
          <div className="product-info-container">
            ...
            <div className="space-y-4 mb-8">
              <div className="rounded-lg border bg-card p-5 shadow-sm">
                ...
                {product.pricing.originalPrice !==
                  ...
                  <div className="mt-2 text-sm font-medium text-green-600">
                    You save {product.pricing.currencySymbol}
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                {product.shipping.freeShipping ? (
                  ...
                  <span>
                    Delivery: {product.pricing.currencySymbol}
                ...
                <div>
                  <div className="flex items-center gap-1">
                    <Link
                      to="/vendor/$vendorId"
                      params={{
                        vendorId: product.vendor.slug || product.vendor.id,
                      }}
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="h-9 w-9 rounded-full border border-muted flex items-center justify-center text-muted-foreground hover:bg-[#1877F2] hover:text-white transition-colors"
              >
              ...
              <button
                ...
                className="h-9 w-9 rounded-full border border-muted flex items-center justify-center text-muted-foreground hover:bg-[#1DA1F2] hover:text-white transition-colors"
              >
              ...
              <button
                ...
                aria-label="Share"
                className="h-9 w-9 rounded-full border border-muted flex items-center justify-center text-muted-foreground hover:bg-[#25D366] hover:text-white transition-colors"
              >
            ...
            <HorizontalScroller>
              {relatedProducts.map((relatedProduct) => (
                <div
                  ...
                  className="w-[160px] flex-shrink-0 sm:w-[200px] md:w-[240px]"
                >
