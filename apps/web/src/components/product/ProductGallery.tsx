...
export function ProductGallery({ images }: ProductGalleryProps) {
  ...
  const canScrollNext =
    thumbnailsStartIndex + VISIBLE_THUMBNAILS < images.length
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="relative mx-auto w-full max-w-md">
        ...
        <div className="overflow-hidden">
          <div
            ...
            style={{
              transform: `translateX(-${thumbnailsStartIndex * (100 / VISIBLE_THUMBNAILS)}%)`,
            }}
          >
      ...
      <Dialog open={isLightboxOpen} onOpenChange={setIsLightboxOpen}>
        <DialogContent
          ...
          className="max-w-[90vw] max-h-[90vh] p-0 border-none bg-black/90 text-white overflow-hidden flex flex-col items-center justify-center"
        >
