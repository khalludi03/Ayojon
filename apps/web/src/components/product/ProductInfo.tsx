...
export function ProductInfo({ product }: ProductInfoProps) {
  ...
  const { currentPrice, originalPrice, currencySymbol, discountPercentage } =
    pricing
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <div className="mt-2 text-sm text-muted-foreground">
          ...
          {vendor.isVerified && (
            <span className="ml-1 inline-flex h-4 w-4 items-center justify-center rounded-full bg-blue-100 text-[10px] font-bold text-blue-800">
              ✓
            </span>
          )}
        </div>
