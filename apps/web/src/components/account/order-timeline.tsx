...
export function OrderTimeline({ status, className }: OrderTimelineProps) {
  ...
  if (currentStatus === 'cancelled') {
    return (
      <div
        className={cn(
          'flex items-center gap-4 p-4 rounded-lg bg-red-50 dark:bg-red-950/20 border border-red-100 dark:border-red-900/30',
          className,
        )}
      >
    ...
    <div className={cn('w-full py-6', className)}>
      <div className="relative flex justify-between">
        ...
        {timelineSteps.map((step, index) => {
          const isCompleted =
            index < currentStepIndex || (index === 3 && currentStepIndex === 3)
              ...
              <div
                className={cn(
                  ...
                  isCompleted
                    ...
                    : isActive
                      ? 'border-primary text-primary shadow-[0_0_0_4px_rgba(var(--primary-rgb),0.1)]'
