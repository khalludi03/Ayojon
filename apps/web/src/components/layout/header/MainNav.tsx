...
const decorDropdownItems: Array<DropdownItem> = [
  ...
  {
    href: '/category/decorations-balloons',
    label: 'View All',
    description: 'Browse decorations & balloons',
  },
]
...
const soundDropdownItems: Array<DropdownItem> = [
  ...
  {
    href: '/category/sound-lighting',
    label: 'View All',
    description: 'Browse sound & lighting',
  },
]
...
const cateringDropdownItems: Array<DropdownItem> = [
  ...
  },
  {
    ...
    label: 'View All',
    description: 'Browse catering equipment',
  },
]
