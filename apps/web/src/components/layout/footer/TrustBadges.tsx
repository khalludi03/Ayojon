...
function CashOnDeliveryIcon({ className }: { className?: string }) {
  return (
    ...
    >
      {/* Hand */}
      <path
        d="M12 32C12 32 14 28 20 28H28C30 28 32 30 32 32V36H12V32Z"
        fill="currentColor"
        opacity="0.2"
      />
      <path
        d="M8 36H36V40C36 41.1 35.1 42 34 42H10C8.9 42 8 41.1 8 40V36Z"
        fill="currentColor"
        opacity="0.3"
      />
      {/* Money/Bills */}
      ...
      {/* Hand outline */}
      <path
        d="M10 34C10 34 12 30 18 30H30C33 30 36 32 36 36"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        fill="none"
...
function NationwideDeliveryIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* Truck cabin */}
      <path
        d="M30 24H38C40 24 42 26 43 28L44 32V36H30V24Z"
        fill="currentColor"
        opacity="0.2"
      />
      <path
      ...
      {/* Location pin */}
      <path
        d="M22 8C22 8 26 4 26 8C26 10 24 14 24 14C24 14 22 10 22 8Z"
        fill="currentColor"
        opacity="0.3"
      />
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4 md:gap-6">
      {badges.map((badge) => (
        ...
        >
          <div
            className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl ${badge.bgColor} group-hover:scale-110 transition-transform duration-300 sm:h-14 sm:w-14`}
          >
            <badge.Icon className={`h-7 w-7 ${badge.color} sm:h-8 sm:w-8`} />
          </div>
          <div className="min-w-0">
            <p className="text-xs font-semibold text-[hsl(var(--foreground))] sm:text-sm">
              {badge.title}
            </p>
            <p className="text-[10px] text-[hsl(var(--muted-foreground))] mt-0.5 sm:text-xs">
              {badge.description}
            </p>
          </div>
        </div>
