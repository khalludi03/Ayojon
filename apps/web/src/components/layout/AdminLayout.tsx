              ...
              >
                <span
                  className={cn(
                    ...
                    isActive ? "opacity-100 bg-[hsl(var(--primary))]" : "opacity-0 group-hover:opacity-40 bg-[hsl(var(--foreground))]"
                  )}
                />
                <Icon className={cn("h-5 w-5 transition-colors", isActive ? "text-[hsl(var(--primary))]" : "text-[hsl(var(--muted-foreground))]")} />
