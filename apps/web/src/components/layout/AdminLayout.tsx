...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Vendor Applications', icon: ShieldCheck, path: '/admin/vendor-applications' }
    ]
  },
  {
    label: 'Business',
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-slate-200 dark:border-slate-800">
          {!sidebarCollapsed && <Logo variant="admin" />}
          <Button
            variant="ghost"
            size="icon"
      ...
      <div className={cn("lg:transition-all lg:duration-300", sidebarCollapsed ? "lg:pl-20" : "lg:pl-64")}>
        ...
        <header className="hidden lg:sticky lg:top-0 lg:z-30 lg:flex lg:h-16 lg:items-center lg:gap-4 lg:border-b lg:border-slate-200 dark:lg:border-slate-800 lg:bg-white/80 dark:lg:bg-slate-900/80 lg:backdrop-blur-sm lg:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Admin Badge */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 border border-indigo-200 dark:border-indigo-800">
              <div className="h-2 w-2 rounded-full bg-green-500 animate-pulse" />
              <span className="text-xs font-black uppercase tracking-wider text-indigo-600 dark:text-indigo-400">Admin</span>
            </div>
          </div>
        </header>
