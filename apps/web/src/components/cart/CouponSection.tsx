...
import { ChevronDown, ChevronUp, Tag, X, Loader2, AlertCircle, Ticket, CheckCircle2 } from 'lucide-react';
            ...
            <div className="flex gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="freeShipping" className="h-5 px-1.5 py-0 text-[10px] uppercase tracking-wider">
                    Applied
                  </Badge>
                </div>
    ...
    <div className="mt-6">
      <button
        ...
        className={cn(
          ...
          isOpen ? "border-[hsl(var(--primary))] bg-[hsl(var(--primary))]/5 text-[hsl(var(--primary))]" : "text-[hsl(var(--muted-foreground))]"
        )}
      >
        <div className="flex items-center gap-2">
