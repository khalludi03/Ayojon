...
import { Flame, Sparkles, TrendingUp, Zap, Filter, ArrowUpDown } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[hsl(var(--background))]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-orange-600 via-red-600 to-rose-700 py-12 text-white sm:py-16 md:py-24">
        <div className="absolute inset-0">
          ...
          <div className="absolute right-1/4 bottom-0 h-64 w-64 translate-x-1/2 rounded-full bg-red-400/20 blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 text-center relative z-10">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg font-medium text-orange-50/90 sm:text-xl md:text-2xl">
            Our most popular items with massive discounts. Don't wait - these trending deals are moving fast!
          </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:py-12">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <h3 className="text-2xl font-bold text-[hsl(var(--foreground))]">No Hot Deals Found</h3>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20">
        <div className="relative overflow-hidden rounded-3xl bg-neutral-900 p-8 sm:p-12">
            ...
            <div className="relative z-10 max-w-xl">
                <h3 className="mb-4 text-2xl font-bold text-white sm:text-3xl">Want to know about deals first?</h3>
                <p className="mb-8 text-neutral-400">Subscribe to our newsletter and get instant notifications about mega flash sales and exclusive hot deals.</p>
