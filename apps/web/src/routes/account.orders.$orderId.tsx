      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="border-2 border-indigo-200 dark:border-indigo-900 shadow-lg overflow-hidden animate-in fade-in slide-in-from-top-4 duration-500">
              ...
              <CardContent className="p-6">
                ...
                <form onSubmit={handleSubmitPayment} className="space-y-4">
                  ...
                  >
                    {submitPaymentMutation.isPending ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <Button onClick={handleBuyAgain} className="gap-2 bg-indigo-600 hover:bg-indigo-700 font-bold">
            ...
            {isDelivered && (
              <Button onClick={handleReturnItems} variant="outline" className="gap-2 font-bold">
        ...
        <div className="space-y-8">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3 px-1">
                ...
                <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-400 font-bold">
                  ...
                  <span className="truncate">{(order as any).user?.email}</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="p-6 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/20 dark:to-purple-950/20 rounded-3xl border-2 border-indigo-100 dark:border-indigo-900 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-black text-slate-900 dark:text-white text-lg">Need Help?</h4>
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-6 font-medium leading-relaxed">
              If you have any questions regarding your order or payment verification, we're here to help.
            </p>
            <div className="space-y-4">
              <a href="tel:+8801234567890" className="flex items-center gap-4 group">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Call us</span>
                  <span className="text-sm font-black text-indigo-600">+880 1234 567890</span>
                </div>
              </a>
              <a href="mailto:support@ayojon.com" className="flex items-center gap-4 group">
                <div className="h-10 w-10 rounded-xl bg-white dark:bg-slate-900 flex items-center justify-center text-indigo-600 border border-indigo-100 dark:border-indigo-900 group-hover:scale-110 transition-transform">
                  <Mail className="h-5 w-5" />
                </div>
                <div className="flex flex-col">
                  <span className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Email us</span>
                  <span className="text-sm font-black text-indigo-600">support@ayojon.com</span>
                </div>
              </a>
            </div>
          </div>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground font-medium">
              We're sorry to see you cancel. Please let us know why you're cancelling your order.
            </DialogDescription>
          </DialogHeader>
          
          <div className="grid gap-6 py-4">
            <div className="space-y-2">
              <Label htmlFor="reason" className="text-sm font-bold">Why are you cancelling? <span className="text-red-500">*</span></Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="comment" className="text-sm font-bold">Additional Comments (Optional)</Label>
              <Textarea 
                id="comment" 
            ...
            <div className="p-4 bg-amber-50 dark:bg-amber-950/30 rounded-xl border border-amber-100 dark:border-amber-800 flex gap-3">
              ...
              <p className="text-xs text-amber-800 dark:text-amber-300 font-medium leading-relaxed">
                Note: Once cancelled, this action cannot be undone. Any refund (if applicable) will be processed according to our policy.
              </p>
            </div>
          </div>

          <DialogFooter className="flex gap-3 sm:gap-0">
            <Button variant="ghost" onClick={() => setIsCancelModalOpen(false)} className="font-bold rounded-xl flex-1 sm:flex-none">
              Stay
            </Button>
            <Button 
            ...
            >
              {cancelOrderMutation.isPending ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
            ...
            <div key={step.id} className="flex flex-col items-center relative z-10 flex-1">
              ...
              <div className="mt-3 text-center">
                <p className={cn(
                  ...
                  isCompleted || isActive ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400"
                )}>
                  {step.label}
                </p>
              </div>
