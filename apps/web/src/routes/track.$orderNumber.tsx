...
function TrackOrderPage() {
  ...
  const handleLookup = (e: React.FormEvent) => {
    ...
    navigate({
      ...
      params: { orderNumber: inputOrderNumber.trim() },
    })
  }
        ...
        <Card className="border-2 border-slate-100 dark:border-slate-800 shadow-xl overflow-hidden mb-8">
          <CardContent className="p-6">
            ...
            >
              <div className="space-y-2 flex-1 w-full">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setInputOrderNumber(event.target.value)
                    }
              ...
              <Button
                type="submit"
                className="h-12 px-8 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/20 w-full sm:w-auto"
              >
                Track Status
              </Button>
            </form>
                    ...
                    {estimatedDelivery &&
                      !['delivered', 'cancelled'].includes(order.status) && (
                        <CardDescription className="text-indigo-600 dark:text-indigo-400 font-bold mt-1">
                          Estimated arrival: {estimatedDelivery.min} -{' '}
                ...
                <CardContent className="border-t border-slate-100 dark:border-slate-800 pt-6">
                  ...
                  <div className="space-y-8">
                    {timelineSteps.map((step, index) => {
                      ...
                      const isInProgress =
                        index === activeIndex && currentStatus !== 'delivered'
                          ...
                          <div className="flex-1 pt-1">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                              ...
                              >
                                {step.label}
                                {isInProgress && (
                                  <span className="ml-2 text-[10px] bg-indigo-100 text-indigo-600 px-2 py-0.5 rounded-full animate-pulse">
                                    In Progress
                                  </span>
                                )}
                              </p>
                                ...
                                <div className="flex flex-wrap items-center gap-4">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <p className="text-xs text-muted-foreground font-medium">
                                      Contact your delivery person for updates.
                                    </p>
                                  </div>
                                  <Button
                                    size="sm"
                                    className="bg-indigo-600 font-bold rounded-lg shadow-md"
                                    disabled
                                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-4 text-center p-10">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground font-medium mt-1">
                          Real-time delivery map is coming soon to your area.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-bold">
                      {(order as any).items?.length || 0} Units
                    </span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-muted-foreground font-medium">
